            ...
            <div class="row m0 m30b">
                <div id="block-status" class="row spBlock m0l w-auto h-100">
                    ...
                    <div class="centered p0 bg-white m30r">
                        <input name="email" type="text" placeholder="abc@gmail.com" class="form-control rounded-0 input-rounded-right" value="{{ isset($params['email']) ? $params['email'] :'' }}">
                    </div>
                    ...
                    <div class="centered p0 bg-white m30r">
                        <input name="name" type="text" placeholder="tran bich" class="form-control rounded-0 input-rounded-right" value="{{ isset($params['name']) ? $params['name'] : '' }}">
                    </div>

                    <div class="centered first-block rounded-left p15r p15l" style="background-color: #6e7a94; min-width: 80px;">
                        <label class="m0 text-white fs16">SDT</label>
                    </div>
                    <div class="centered p0 bg-white m20r">
                        <input name="phone" type="text" placeholder="01683024581" class="form-control input-rounded-right rounded-0" value="{{ isset($params['phone']) ? $params['phone'] : '' }}">
                    </div>
