                ...
                <div class="content-wrapper" style="background-color: white;">
                    <table class="table table-bordered table-striped border-0 m0">
                        ...
                        <tr>
                            ...
                            @switch($tableType)
                                @case(INFANTS)
                                <th class="text-center">Vòng đầu (cm)</th>
                                @break
                                @case(TODDLER)
                                <th class="text-center">Vòng cánh tay (cm)</th>
                                <th class="text-center">Nếp gấp da ở cơ tam đầu (cm)</th>
                                @break
                                @case(CHILDREN)
                                <th class="text-center">Vòng cánh tay (cm)</th>
                                <th class="text-center">Vòng đầu (cm)</th>
                                <th class="text-center">Vòng ngực (cm)</th>
                                <th class="text-center">Nếp gấp da ở cơ tam đầu (cm)</th>
                                @break
                                @case(TEENS)
                                <th class="text-center">Nếp gấp da ở cơ tam đầu (cm)</th>
                                <th class="text-center">Phần trăm mỡ của cơ thể (%)</th>
                                @break
                                @case(ADULTS)
                                <th class="text-center">Vòng cánh tay (cm)</th>
                                <th class="text-center">Nếp gấp da ở cơ tam đầu (cm)</th>
                                ...
                                <th class="text-center">Vòng cánh tay (cm)</th>
                                <th class="text-center">Nếp gấp da ở cơ tam đầu (cm)</th>
                                <th class="text-center">Chiều cao đầu gối (cm)</th>
                                <th class="text-center">Vòng bụng chân (cm)</th>
                                @break
                            @endswitch
                        ...
                        @forelse($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href=""
                                       class="btn btn-success border-0 btn-topic-custom btn-accept-topic-student @if(in_array($tableType, [CHILDREN, SENIORS, ADULTS])) mb-3 @else mr-3 @endif text-white"
                                       data-toggle="tooltip" data-placement="top" title="Chỉnh sửa"><i
                                            class="fa fa-edit"></i></a>
                                    <button class="delete-record btn btn-danger border-0 btn-topic-custom"
