...
class ProvinceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $northern = ['Lào Cai', 'Yên Bái', 'Điện Biên', 'Hòa Bình', 'Lai Châu', 'Sơn La', 'Hà Giang', 'Cao Bằng', 'Bắc Kạn', 'Lạng Sơn', 'Tuyên Quang', 'Thái Nguyên', 'Phú Thọ', 'Bắc Giang', 'Quảng Ninh', 'Bắc Ninh', 'Hà Nam', 'Hà Nội', 'Hải Dương', 'Hưng Yên', 'Hải Phòng', 'Nam Định', 'Ninh Bình', 'Thái Bình', 'Vĩnh Phúc'];
        $south = ['Bình Phước', 'Bình Dương', 'Đồng Nai', 'Tây Ninh', 'Bà Rịa-Vũng Tàu', 'Thành phố Hồ Chí Minh', 'Long An', 'Đồng Tháp', 'Tiền Giang', 'An Giang', 'Bến Tre', 'Vĩnh Long', 'Trà Vinh', 'Hậu Giang', 'Kiên Giang', 'Sóc Trăng', 'Bạc Liêu', 'Cà Mau', 'Thành phố Cần Thơ'];
        $center = ['Thanh Hoá' , 'Nghệ An',  'Hà Tĩnh' , 'Quảng Bình',  'Quảng Trị', 'Thừa Thiên-Huế', 'Đà Nẵng', 'Quảng Nam', 'Quảng Ngãi', 'Bình Định', 'Phú Yên', 'Khánh Hoà', 'Ninh Thuận', 'Bình Thuận', 'Kon Tum', 'Gia Lai', 'Đắc Lắc', 'Đắc Nông','Lâm Đồng'];
        $array_area = [$northern, $south, $center];
        $array_district = [
            [$c36, $c63, $c20, $c28, $c35, $c52, $c22, $c13, $c4, $c37, $c60, $c55, $c44, $c5, $c49, $c6, $c23, $c24, $c26, $c30, $c27, $c40, $c42, $c54, $c62],
            [$c10, $c8, $c18, $c53, $c2, $c31, $c39, $c19, $c58, $c1, $c7, $c61, $c59, $c29, $c33, $c51, $c3, $c12, $c14],
            [$c56, $c41, $c25, $c46, $c50, $c57, $c15, $c47, $c48, $c9, $c45, $c32, $c43, $c11, $c34, $c21, $c16, $c17, $c38]
        ];

        $index = 1;
        foreach ($array_area as $areaId => $area) {
            foreach ($area as $provinceId => $province) {
